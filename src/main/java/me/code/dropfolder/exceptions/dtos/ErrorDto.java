package me.code.dropfolder.exceptions.dtos;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.fasterxml.jackson.annotation.JsonProperty;
import lombok.Getter;
import me.code.dropfolder.exceptions.dtos.details.ErrorDetail;
...
public class ErrorDto {
    ...
    /**
     * Adds an error details to the list of error details.
     *
     * @param errorDetail The error details to be added.
