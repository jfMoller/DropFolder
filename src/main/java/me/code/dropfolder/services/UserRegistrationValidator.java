...
import me.code.dropfolder.exceptions.types.NonUniqueValueException;
...
public class UserRegistrationValidator {
    ...
    // ErrorDto details messages; determines the message passed as part of the ValidationErrorDetail
     ...
     * If either of them is null, it throws a respective formatting exceptions.
     *
     * @param username The username to be validated.
     * @param password The password to be validated.
    ...
    /**
     * Generates a ValidationErrorDetail object based on the provided types and value.
     *
     * @param type  The types of validation error (username or password).
     * @param value The value that failed validation.
     * @return A ValidationErrorDetail object.
     * @throws IllegalArgumentException If the provided types is invalid.
     */
